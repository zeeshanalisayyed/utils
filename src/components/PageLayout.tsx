...
export function PageLayout({ children, title, description, showBackButton = true }: PageLayoutProps) {
  ...
  // Track tool usage for "Recently Used" on the homepage
  useToolUsage(location.pathname);
          ...
          <div className="flex gap-8">
            ...
            <aside className="hidden xl:block w-[300px] flex-shrink-0">
              <div className="sticky top-20 space-y-6">
                <AdBanner format="rectangle" style={{ minHeight: '250px' }} />
                <AdBanner format="vertical" style={{ minHeight: '600px' }} />
              </div>
            </aside>
          </div>
        </div>
